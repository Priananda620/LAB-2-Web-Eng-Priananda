...
<body>
    ...
    <div id="full-page-container">
        ...
        <section id="hero">
            ...
            <svg class="sw" width="564" height="552" viewBox="0 0 564 552" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
            ...
            <div class="d-flex justify-content-around align-items-center">
                <div id="landing-display-text">
                    ...
                    <h1 class="fw-bold">
                        ...
                        <span>Tutor Booking</span><br>
                        <!-- <span>Service</span><br> -->
                        <span>
                            <span>
                                <span>S</span>
                                <span class="hero-text-double">S</span>
                            </span>
                            <span>
                                <span>e</span>
                            ...
                            <span>
                                <span>r</span>
                                <span class="hero-text-double">r</span>
                            </span>
                            <span>
                                <span>v</span>
                                <span class="hero-text-double">v</span>
                            </span>
                            <span>
                                <span>i</span>
                            ...
                            <span>
                                <span>c</span>
                                <span class="hero-text-double">c</span>
                            </span>
                            <span>
                                <span>e</span>
                                <span class="hero-text-double">e</span>
        ...
        <section id="section-2" class="section-child" style="padding: 3em 0;">
            ...
            <div class="mt-5 text-center section-text">
                ...
                <a style="width: 15em; margin:auto" class="button" href="https://www.linkedin.com/in/priananda-azhar/" target="_blank" rel="noopener noreferrer">Linkedin</a>
            </div>
        </section>
